...
# Use the credentials found in backend/.env which seem to be correct, BUT use aws-1 pooler which was in the .env file
DATABASE_URL = "postgresql://postgres.vmeerziytzluvqcijsib:CRMaster2026JP@aws-1-sa-east-1.pooler.supabase.com:6543/postgres"
